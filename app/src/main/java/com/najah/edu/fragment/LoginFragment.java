package com.najah.edu.fragment;
...
import com.najah.edu.BaseFragment;
...
public class LoginFragment extends BaseFragment {
    ...
    private void initEditTextObservable() {
        mEmailObservable = RxTextView.textChanges(edt_email1);
        mPasswordObservable = RxTextView.textChanges(edt_password1);
    }
    ...
    private void signInButtonState(int whichCase) {
        switch (whichCase) {
            case 1: // enable button
                ...
                //cc.setemail(edt_email1.getText().toString().trim());
                //cc.setpass(edt_password1.getText().toString().trim());
                //Bundle bundle = new Bundle();
                //bundle.putString("EEEmail",edt_email1.getText().toString().trim());
                //bundle.putString("PPPass",edt_password1.getText().toString().trim());
                break;
